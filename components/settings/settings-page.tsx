...
export function SettingsPageClient() {
  ...
  const currentProviderName = currentProvider?.name ?? "Selected provider";
  const currentProviderLogo = currentProvider?.logo ?? "openai";
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-2">
              ...
              <div className="flex items-center gap-2 text-sm">
                <Image
                  src={`https://models.dev/logos/${currentProviderLogo}.svg`}
                  alt={currentProviderName}
                  width={16}
                  height={16}
                  className="h-4 w-4 dark:invert"
                />
                <span className="font-medium">{currentProviderName}</span>
